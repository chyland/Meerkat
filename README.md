...
Meerkat currently starts at the last MIT release of Mongoose.  The basic feature list is below:
...
# Meerkat Revision Author

I'm Cory Hyland from these United States and I'm actively programming C++ applications.  I'm hoping to make Meerkat into a highly useful library in continuation of the original Mongoose project.  I'm using this webserver in my own projects and hope that someone will find the changes useful.  The project will remain under the MIT license so that anyone can make use of it without concern for cumbersome licensing.

# Mongoose Original Author
